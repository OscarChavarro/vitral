...
public class JoglPolyhedralBoundedSolidRenderer extends JoglRenderer
{
    ...
    {
        JoglPolyhedralBoundedSolidFaceRenderer.drawDebugFaceBoundary(gl, solid,
            faceIndex);
    }
    ...
    {
        JoglPolyhedralBoundedSolidFaceRenderer.drawDebugFace(gl, solid,
            faceIndex);
    }
    ...
    */
         ...
         Camera c, RendererConfiguration quality)
    {
        ...
        if ( quality.isSurfacesSet() ) {
            ...
            JoglPolyhedralBoundedSolidFaceRenderer.drawSurfaces(gl, solid);
        }
        if ( quality.isWiresSet() ) {
            drawEdges(gl, solid);
        }
        if ( quality.isPointsSet() ) {
            JoglPolyhedralBoundedSolidVertexRenderer.drawPoints(gl, solid);
        }
        if ( quality.isNormalsSet() ) {
            JoglPolyhedralBoundedSolidVertexRenderer.drawVertexNormals(gl,
                solid);
        }
