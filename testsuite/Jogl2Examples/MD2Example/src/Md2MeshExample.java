...
public class Md2MeshExample
    ...
    //private Jogl2Md2MeshRenderer Md2MeshRend = new Jogl2Md2MeshRenderer();
...
//        texture  = "D:\\Leonardo\\TrabajoPolitecnica\\__Modelos\\MD2\\Nina\\Avatar_Nina_Body_Dm_ajustes.jpg";
    ...
    private void drawObjectsGL(GL2 gl) {
        ...
        Jogl2Md2MeshRenderer.draw(gl,md2Mesh); //LRR
    ...
    public void init(GLAutoDrawable drawable) {
        Jogl2Md2MeshRenderer.initGL(drawable.getGL().getGL2(), md2Mesh);
