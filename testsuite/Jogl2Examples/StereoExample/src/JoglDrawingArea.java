...
{
    private Jogl2StereoStrategyRenderer stereoStrategy;

    public JoglDrawingArea(Jogl2StereoStrategyRenderer stereoStrategy)
    {
    ...
    public void setStereoStrategy(Jogl2StereoStrategyRenderer stereoStrategy)
    {
        this.stereoStrategy = stereoStrategy;
    }
    ...
    public void drawCenterModel(GL2 gl)
    {
        ...
        Jogl2CameraRenderer.activate(gl, c);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        stereoStrategy instanceof Jogl2StereoStrategyCyclopeanZBufferRenderer ||
        stereoStrategy instanceof Jogl2StereoStrategyAutostereogramRenderer
        ) {
