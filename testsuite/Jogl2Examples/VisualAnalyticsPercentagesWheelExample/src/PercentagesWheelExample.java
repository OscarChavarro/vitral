...
import vsdk.toolkit.render.jogl.visualAnalytics.Jogl2PercentageWheelWidgetRenderer;
...
//= PROGRAM PART 4/5: JOGL-OPENGL PROCEDURES ================================
    ...
    private void drawObjectsGL(GL2 gl)
    {
        ...
        gl.glLoadIdentity();
        Jogl2PercentageWheelWidgetRenderer.draw(
...
//= PART 5/5: GUI PROCEDURES ================================================
    ...
    */
    ...
    private void configureForHUD(GL2 gl, Camera camera) {
        ...
        // Jogl2PercentageWheelWidgetRenderer is behaving in a rare form...
        if ( dy > dx ) {
