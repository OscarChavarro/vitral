...
TASK=":testsuite:ApplicationCases:SceneEditorApplication:runMain"
MAIN_CLASS="application.SceneEditorApplication"
RUN_JVM_ARGS="-Djava.library.path=../../../lib|-Xms300m|-Xmx300m"
DEFAULT_ARGS=()
