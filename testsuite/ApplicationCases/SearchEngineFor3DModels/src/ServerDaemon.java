...
public class ServerDaemon extends JoglShapeMatchingOfflineRenderable implements GLEventListener
{
    ...
    private void exportResults(ArrayList <Result> similarModels, ArrayList<GeometryMetadata> descriptorsArray)
    {
        ...
        startWriter();
        write("<HTML>\n");
        write("<H1>VITRAL IMPLEMENTATION OF A 3D MODEL SEARCH ENGINE</H1>\n");
        write("<B>Search results in database [test]</B>, " + descriptorsArray.size() + " models         (click on a thumbnail for more information on that model)\n");
        write("<CENTER>\n");
        write("<TABLE BORDER=0 WIDTH=100% CELLPADDING=3 CELLSPACING=3>\n");
	...
	String filename, fullpath;
        ...
        for ( i = 0; i < similarModels.size(); i++ ) {
            ...
            write("<TD WIDTH=25% VALIGN=CENTER ALIGN=CENTER>\n");
        ...
        write("This page was automatically generated by VITRAL\n");
        write("More information available at <A HREF=\"http://sophia.javeriana.edu.co/~ochavarr\">http://sophia.javeriana.edu.co/~ochavarr</A>\n");
        write("</HTML>\n");
        stopWriter();
    }

    public void runCommand(GL gl, String command[])
    {
