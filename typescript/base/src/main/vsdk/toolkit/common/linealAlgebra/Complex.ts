...
export class Complex extends FundamentalEntity {
    ...
    public plus(b: Complex): Complex {
        return new Complex(this.r + b.r, this.i + b.i);
    }
    public minus(b: Complex): Complex {
        return new Complex(this.r - b.r, this.i - b.i);
    }
    ...
    public times(value: Complex | number): Complex {
        return typeof value === "number"
            ? new Complex(value * this.r, value * this.i)
            : new Complex(this.r * value.r - this.i * value.i, this.r * value.i + this.i * value.r);
    }
    public conjugate(): Complex {
        return new Complex(this.r, -this.i);
    }
    public reciprocal(): Complex {
        const scale = this.r * this.r + this.i * this.i;
        return new Complex(this.r / scale, -this.i / scale);
    }
    ...
    public static plus(a: Complex, b: Complex): Complex {
        return new Complex(a.r + b.r, a.i + b.i);
    }
    public override toString(): string {
        return this.i < 0
            ? `${VSDK.formatDouble(this.r)} - ${VSDK.formatDouble(-this.i)}i`
            : `${VSDK.formatDouble(this.r)} + ${VSDK.formatDouble(this.i)}i`;
    }
}
