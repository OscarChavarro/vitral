...
export class Throwable extends Error {
  ...
  public getMessage(): string | undefined { return this.message.length === 0 ? undefined : this.message; }
  public getCause(): Throwable | undefined { return this.throwableCause; }
  ...
  public override toString(): string { return this.message.length === 0 ? this.name : `${this.name}: ${this.message}`; }
}
