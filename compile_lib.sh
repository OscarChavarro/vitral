...
BASIC_CLASSES="vsdk/toolkit/common/*.java vsdk/toolkit/environment/*.java vsdk/toolkit/environment/geometry/*.java vsdk/toolkit/environment/geometry/polyhedralBoundedSolidNodes/*.java vsdk/toolkit/environment/scene/*.java vsdk/toolkit/media/*.java vsdk/toolkit/render/*.java vsdk/toolkit/gui/Gizmo.java vsdk/toolkit/gui/ProgressMonitor.java vsdk/toolkit/gui/ProgressMonitorConsole.java vsdk/toolkit/gui/Controller.java vsdk/toolkit/gui/PresentationElement.java vsdk/toolkit/processing/*.java vsdk/toolkit/gui/KeyEvent.java"

IO_CLASSES="vsdk/toolkit/io/*.java vsdk/toolkit/io/metadata/*.java vsdk/toolkit/io/image/ImageNotRecognizedException.java vsdk/toolkit/io/image/ImagePersistenceSGI.java vsdk/toolkit/io/image/RGBColorPalettePersistence.java vsdk/toolkit/io/geometry/EnvironmentPersistence.java vsdk/toolkit/io/geometry/FontReader.java vsdk/toolkit/io/geometry/ParametricBiCubicPatchPersistence.java vsdk/toolkit/io/geometry/ParametricCurvePersistence.java vsdk/toolkit/io/geometry/Reader3ds.java vsdk/toolkit/io/geometry/ReaderAse.java"
