...
BASIC_CLASSES="vsdk/toolkit/common/*.java vsdk/toolkit/environment/*.java vsdk/toolkit/environment/geometry/*.java vsdk/toolkit/environment/geometry/polyhedralBoundedSolidNodes/*.java vsdk/toolkit/environment/scene/*.java vsdk/toolkit/media/*.java vsdk/toolkit/render/*.java vsdk/toolkit/gui/Gizmo.java vsdk/toolkit/gui/ViewportWindow.java vsdk/toolkit/gui/ProgressMonitor.java vsdk/toolkit/gui/ProgressMonitorConsole.java vsdk/toolkit/gui/Controller.java vsdk/toolkit/gui/PresentationElement.java vsdk/toolkit/processing/*.java vsdk/toolkit/gui/KeyEvent.java"
