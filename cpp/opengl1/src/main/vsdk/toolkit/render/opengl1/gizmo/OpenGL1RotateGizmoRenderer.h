#ifndef __OPEN_GL_1_ROTATE_GIZMO_RENDERER__
#define __OPEN_GL_1_ROTATE_GIZMO_RENDERER__
...
/**
Renders a `RotateGizmo` with the OpenGL 1.2 fixed function pipeline (see
`OpenGL1ColoredPrimitiveRenderer`).
...
gizmo has been set):
<pre>
    OpenGL1RotateGizmoRenderer::draw(gizmo, camera);
</pre>
*/
class OpenGL1RotateGizmoRenderer {
private:
