#ifndef __PROCESSING_ELEMENT__
#define __PROCESSING_ELEMENT__
...
self-contained algorithms, but can constitute also the placeholder for
wrappers that call external libraries and tools (as VTK, ITK, image
processing toolkits, computational geometry toolkits and external utilities).
