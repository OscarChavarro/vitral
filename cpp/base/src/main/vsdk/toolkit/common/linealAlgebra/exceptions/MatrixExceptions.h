...
public:
    explicit MatrixDimensionMismatchException(const std::string& message) : std::invalid_argument(message) {}
};

class MatrixIndexOutOfBoundsException : public std::out_of_range {
public:
    explicit MatrixIndexOutOfBoundsException(const std::string& message) : std::out_of_range(message) {}
};

class MatrixNotSquareException : public std::invalid_argument {
public:
    explicit MatrixNotSquareException(const std::string& message) : std::invalid_argument(message) {}
};

class MatrixSingularException : public std::runtime_error {
public:
    explicit MatrixSingularException(const std::string& message) : std::runtime_error(message) {}
};
