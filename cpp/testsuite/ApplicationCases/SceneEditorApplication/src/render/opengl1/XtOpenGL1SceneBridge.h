#ifndef __XT_OPENGL1_SCENE_BRIDGE__
#define __XT_OPENGL1_SCENE_BRIDGE__
...
scale gizmos) and its OpenGL1 drawing-area renderer. Its implementation
...
private:
    ...
    XtOpenGL1SceneBridge(const XtOpenGL1SceneBridge& other);
    XtOpenGL1SceneBridge& operator=(const XtOpenGL1SceneBridge& other);
...
public:
    ...
    */
    XtOpenGL1SceneBridge(OpenGL1LabelImageProvider* labels,
                         Listener* listener);
    ~XtOpenGL1SceneBridge();
