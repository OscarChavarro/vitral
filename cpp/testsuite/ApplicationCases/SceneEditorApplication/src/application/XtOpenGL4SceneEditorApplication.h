#ifndef __XT_OPENGL4_SCENE_EDITOR_APPLICATION__
#define __XT_OPENGL4_SCENE_EDITOR_APPLICATION__
...
/**
The scene editor application with its Xt GUI and its OpenGL 4 drawing
area, as offered to the classes that work over it without presenting it
(i.e. the automation service, `XtOpenGL4VitralEditorMCP`), like
...
public:
    virtual ~XtOpenGL4SceneEditorApplication() {}
    ...
    */
    virtual XtOpenGL4ApplicationController* getOpenGL4Controller() = 0;
