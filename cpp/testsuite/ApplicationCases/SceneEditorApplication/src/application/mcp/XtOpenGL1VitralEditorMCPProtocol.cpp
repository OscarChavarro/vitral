...
XtOpenGL1VitralEditorMCPProtocol::XtOpenGL1VitralEditorMCPProtocol(
    XtOpenGL1SceneEditorApplication* parent, java::net::Socket* socket)
    : parent(parent), socket(socket)
{
}

void XtOpenGL1VitralEditorMCPProtocol::run()
{
    try {
        ...
        fprintf(stderr, "Error on XtOpenGL1VitralEditorMCPProtocol!\n%s\n",
                e.what());
    }
}

java::String XtOpenGL1VitralEditorMCPProtocol::handle(
...
java::String XtOpenGL1VitralEditorMCPProtocol::callTool(
...
java::String XtOpenGL1VitralEditorMCPProtocol::executeTool(
    const java::String& tool, const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::listLanguages()
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::setLanguage(
    const java::String& request)
{
...
*/
java::String XtOpenGL1VitralEditorMCPProtocol::exitApplication()
{
...
*/
void XtOpenGL1VitralEditorMCPProtocol::recordSceneChange(
...
*/
java::String XtOpenGL1VitralEditorMCPProtocol::describeEditHistory()
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::queueJson(UndoQueue* queue)
{
...
*/
java::String XtOpenGL1VitralEditorMCPProtocol::executeGuiCommand(
    const java::String& request)
{
...
void XtOpenGL1VitralEditorMCPProtocol::clearScene()
{
...
void XtOpenGL1VitralEditorMCPProtocol::addPointLight(
    const java::String& request)
{
...
bool XtOpenGL1VitralEditorMCPProtocol::hasProperty(const java::String& json,
...
void XtOpenGL1VitralEditorMCPProtocol::addSphere(const java::String& request)
{
...
void XtOpenGL1VitralEditorMCPProtocol::addCone(const java::String& request)
{
...
void XtOpenGL1VitralEditorMCPProtocol::addCylinder(const java::String& request)
{
    double radius = numberProperty(request, "radius", 1.0);
    double height = numberProperty(request, "height", 2.0);
    placeNewBody(parent->getApplicationModel(),
...
void XtOpenGL1VitralEditorMCPProtocol::moveBody(const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::setInteractionMode(
    const java::String& request)
{
...
XtOpenGL1VitralEditorMCPProtocol::getDrawingAreaController()
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::injectMouse(
    const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::injectKey(
    const java::String& request)
{
    XtOpenGL1ApplicationController* drawingArea = getDrawingAreaController();
...
*/
java::String XtOpenGL1VitralEditorMCPProtocol::projectSelectedBody(
    const java::String& request)
{
    XtOpenGL1ApplicationController* drawingArea = getDrawingAreaController();
    Scene* scene = parent->getApplicationModel()->getScene();
...
void XtOpenGL1VitralEditorMCPProtocol::selectBody(const java::String& request)
{
    Scene* scene = parent->getApplicationModel()->getScene();
...
XtOpenGL1VitralEditorMCPProtocol::selectedViewports(
    const java::String& request)
{
    ViewportSet* set = parent->getApplicationModel()->getActiveViewportSet();
...
void XtOpenGL1VitralEditorMCPProtocol::setRendererConfiguration(
    const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::describeRendererConfigurations(
    const java::String& request)
{
    java::StringBuilder sb;
    ViewportSet* set = parent->getApplicationModel()->getActiveViewportSet();
...
java::String XtOpenGL1VitralEditorMCPProtocol::raytracePng(
    const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::viewportJpg(
    const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::workspaceJpg(
    const java::String& request)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::describeScene()
{
    Scene* scene = parent->getApplicationModel()->getScene();
    java::StringBuilder sb;
    sb.append("{\"bodies\":[");
...
java::String XtOpenGL1VitralEditorMCPProtocol::toolsJson()
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::tool(const char* name,
...
java::String XtOpenGL1VitralEditorMCPProtocol::content(const java::String& json)
{
    return java::String("{\"content\":[{\"type\":\"text\",\"text\":\"")
        + escape(json) + "\"}],\"isError\":false}";
}

java::String XtOpenGL1VitralEditorMCPProtocol::result(const java::String& id,
...
java::String XtOpenGL1VitralEditorMCPProtocol::error(
...
java::String XtOpenGL1VitralEditorMCPProtocol::vector(const Vector3Dd& v)
{
    java::StringBuilder sb;
...
java::String XtOpenGL1VitralEditorMCPProtocol::color(const ColorRgb& c)
{
    java::StringBuilder sb;
...
java::String XtOpenGL1VitralEditorMCPProtocol::stringProperty(
...
java::String XtOpenGL1VitralEditorMCPProtocol::nestedStringProperty(
    const java::String& json, const java::String& key,
    const java::String& defaultValue)
{
...
java::String XtOpenGL1VitralEditorMCPProtocol::idProperty(
    const java::String& json)
{
...
double XtOpenGL1VitralEditorMCPProtocol::numberProperty(
...
bool XtOpenGL1VitralEditorMCPProtocol::booleanProperty(
...
java::String XtOpenGL1VitralEditorMCPProtocol::escape(const java::String& in)
{
