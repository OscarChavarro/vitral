#ifndef __XT_OPENGL1_GUI_EVENT_EXECUTOR__
#define __XT_OPENGL1_GUI_EVENT_EXECUTOR__
...
*/
class XtOpenGL1GuiEventExecutor : public CommandListener {
private:
...
public:
    explicit XtOpenGL1GuiEventExecutor(XtApplicationHost* parent);
