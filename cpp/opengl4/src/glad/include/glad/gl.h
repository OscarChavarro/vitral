 ...
 *
 * Commandline:
 *    --api='gl:core=4.1' --extensions='GL_EXT_texture_compression_s3tc' c
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acore%3D4.1&extensions=GL_EXT_texture_compression_s3tc&generator=c&options=
 *
 */
