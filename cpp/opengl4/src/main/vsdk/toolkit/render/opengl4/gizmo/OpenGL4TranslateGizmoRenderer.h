...
/**
Renders a `TranslateGizmo` with the GL4 core pipeline (see
`OpenGL4ColoredPrimitiveRenderer`). The geometric model of the gizmo (arrows,
...
gizmo has been set):
<pre>
    OpenGL4TranslateGizmoRenderer::draw(gizmo, camera);
</pre>
*/
class OpenGL4TranslateGizmoRenderer {
private:
