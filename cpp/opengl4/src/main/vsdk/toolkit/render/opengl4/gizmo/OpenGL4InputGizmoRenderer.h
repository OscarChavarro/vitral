#ifndef __OPEN_GL_4_INPUT_GIZMO_RENDERER__
#define __OPEN_GL_4_INPUT_GIZMO_RENDERER__
...
/**
Renders an `InputGizmo` over a viewport with the GL4 core pipeline, at
...
*/
class OpenGL4InputGizmoRenderer {
public:
    /**
...
public:
    ...
    */
    OpenGL4InputGizmoRenderer(Host* host, ViewportSet* viewportSet,
                              Viewport* viewport);
    ~OpenGL4InputGizmoRenderer();
