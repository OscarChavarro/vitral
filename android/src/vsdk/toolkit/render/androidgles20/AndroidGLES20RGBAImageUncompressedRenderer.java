...
public class AndroidGLES20RGBAImageUncompressedRenderer extends AndroidGLES20Renderer
{
    private static ArrayList<_AndroidGLES20RGBAImageUncompressedRendererAssociation> compiledImages;

    static {
        compiledImages = new ArrayList<_AndroidGLES20RGBAImageUncompressedRendererAssociation>();
    }
    ...
    private static int activateBase(RGBAImageUncompressed img)
    {
        ...
        _AndroidGLES20RGBAImageUncompressedRendererAssociation item = null;
        ...
        if ( glListIsCompiled == false ) {
            //----
            item = new _AndroidGLES20RGBAImageUncompressedRendererAssociation();
            item.image = img;
            item.glList = 1;
