...
public class SolverPolynomialQuarticBairstow {
    private static double real[]=new double[4];
    private static double img[]=new double[4];
     ...
     */
    public static void setReal(double[] aRes) {
        real = aRes;
    }
     ...
     */
    public static void setImg(double[] aImg) {
        img = aImg;
    }
    
    public SolverPolynomialQuarticBairstow(double a4,double a3, double a2, double a1, double a0)
    {
   ...
   // double a[] ={2, -1, 0, -.16666, .08333, -8.33e-3, 0, -1.98e-4, 4.96e-5, -2.75e-6, 0, 2.50e-8};
    
    double a[] ={945, -744, 206, -24, 1};
