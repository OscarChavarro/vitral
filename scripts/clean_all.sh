...
rm -rf `find . -name "*~"` `find . -name "*.jar"` `find . -name "*.war"` `find . -name "*.class"` `find . -name "output.jpg"` `find . -name "output.ppm"` `find . -name "output.png"` `find . -name "output.bmp"` `find . -name "target"` ./doc/html_doxygen ./doc/html_javadoc ./doc/_doxygen/warnings.log
