...
public class Jogl2SimpleCorridorSample
{
    private double a;
    private int na;
    private double b;
    ...
    public Jogl2SimpleCorridorSample()
    {
        a = 6;
        na = 6;
        b = 20;
    ...
    public void drawGL(GL2 gl)
    {
        ...
        for ( i = 0; i < 4; i++ ) {
            switch ( i ) {
              case 0: gl.glColor3d(0.9, 0.5, 0.5); break;
              case 1: gl.glColor3d(0.5, 0.9, 0.5); break;
              case 2: gl.glColor3d(1, 0, 0); break;
              case 3: gl.glColor3d(0, 1, 0); break;
            }
            gl.glPushMatrix();
            gl.glRotated(90*i, 0, 0, 1);
            drawTilesWallA(gl);
