    ...
    extends _PolyhedralBoundedSolidOperator
{
    ...
    */
    ...
    as proposed in section 15.6.1 and problem 15.4. The {@code useMirrorFace}
    flag of the underlying processor is always {@code false} here: the
