...
{@link _PolyhedralBoundedSolidSetOperator#separateEdgeSequence}, after the
...
{@link _PolyhedralBoundedSolidSetOperator.SeparateEdgeSequenceResult#FAILED_CYCLE_DETECTED}.</p>
...
class VertexVertexEndpointRecoveryTest
{
    ...
    static void resolveReflectionHandles() throws Exception
    {
        ...
        resultEnum = Class.forName(
            ...
            + "_PolyhedralBoundedSolidSetOperator$SeparateEdgeSequenceResult");
    }
