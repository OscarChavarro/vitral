...
import gui.SolidTextureKeyboardInteractionTechniques;
import gui.SolidTextureMouseInteractionTechniques;
...
public class SolidTextureExample
    extends JFrame implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {

    private SolidTextureModel model;
    private CommandLineOptions commandLineOptions;
    private CameraController cameraController;
    private RendererConfigurationController qualityController;
    private SolidTextureMouseInteractionTechniques mouseInteractionTechniques;
    private SolidTextureKeyboardInteractionTechniques keyboardInteractionTechniques;
    public GLCanvas canvas;
    private Jogl4DebuggerRenderer renderer;

    public SolidTextureExample(String fileName) {
        super("VITRAL mesh test - JOGL");
        File file = null;

        model = new SolidTextureModel();
    ...
    public SolidTextureModel getModel() {
        return model;
    }
    ...
    public static void main(String[] args) {
        JFrame f;
        SolidTextureExample app;

        app = new SolidTextureExample(extractFileName(args));
