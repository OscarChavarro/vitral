...
public class Light
{
    ...
    //added 26/04/2006
    private double constantAtenuation=1; 
    private double linearAtenuation=1;
    private double quadricAtenuation=1;
    private boolean useAtenuation;
    //end added 26/04/2006
    ...
    //added 26/04/2006
    public void setAtenuation(double constant, double linear, double quadric)
    {
        constantAtenuation=constant; 
        linearAtenuation=linear;
        quadricAtenuation=quadric;
        useAtenuation=true;
    }
    
    public boolean usesAtenuation()
    {
        return useAtenuation;
    }
    
    public double getConstantAtenuation()
    {
        return constantAtenuation;
    }
    
    public double getLinearAtenuation()
    {
        return linearAtenuation;
    }
    
    public double getQuadricAtenuation()
    {
        return quadricAtenuation;
    }
    
    public void setConstantAtenuation(double ca)
    {
        constantAtenuation=ca;
        useAtenuation=true;
    }
    
    public void setLinearAtenuation(double la)
    {
        linearAtenuation=la;
        useAtenuation=true;
    }
    
    public void setQuadricAtenuation(double qa)
    {
        quadricAtenuation=qa;
        useAtenuation=true;
    }
    //end added 26/04/2006
