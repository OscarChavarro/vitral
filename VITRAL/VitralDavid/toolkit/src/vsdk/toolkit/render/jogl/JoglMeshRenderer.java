...
{
    private static HashMap<Mesh, TextureDecorator> objTex = new HashMap<Mesh, TextureDecorator>();
    ...
    public static void initTexture(GL gl, Mesh m)
    {
        ...
        //System.out.println(td.textObjects.length);
        ...
        for (int i = 0; i < td.textObjects.length; i++)
        {
            ...
            gl.glTexImage2D(gl.GL_TEXTURE_2D, 0, colors, m.getTextureAt(i).getXSize()
                    , m.getTextureAt(i).getYSize(), 0, colors,
                    gl.GL_UNSIGNED_BYTE, ByteBuffer.wrap(m.getTextureAt(i)
                            .getRawImage()));
            /*
            gl.glTexImage2D(gl.GL_TEXTURE_2D, 0, colors, m.getTextureAt(i)
                    .getXSize(), m.getTextureAt(i).getYSize(), 0, colors,
                    gl.GL_UNSIGNED_BYTE, ByteBuffer.wrap(m.getTextureAt(i)
                            .getRawImage()));*/
        }
    ...
    public static void drawVertexNormal(GL gl, Vertex vertex)
    {
        ...
        gl.glVertex3d(vertex.getPosition().x, vertex.getPosition().y, vertex
                .getPosition().z);
        gl.glVertex3d(vertex.getPosition().x + (vertex.getNormal().x * 0.1),
                vertex.getPosition().y + (vertex.getNormal().y * 0.1), vertex
                        .getPosition().z
                        + (vertex.getNormal().z * 0.1));
        gl.glEnd();
    }
    ...
    public static void drawWithSelection(GL gl, Mesh mesh,
            QualitySelection quality, boolean flip, int[] selectedTriangles)
    {
        if (quality.isSurfacesSet())
        {
            int qt = quality.getShadingType();
    ...
    public static void drawSurfacesSmooth(GL gl, Mesh mesh, boolean flip)
    {
        ...
        for (int i = 0; i < mesh.getTriangles().length; i++)
        {
            gl.glBegin(gl.GL_TRIANGLES);
            {
                if (flip == false)
                {
                    gl.glNormal3d(mesh.getVertexAt(
                            mesh.getTriangleAt(i).getPoint0()).getNormal().x,
                            mesh.getVertexAt(mesh.getTriangleAt(i).getPoint0())
                                    .getNormal().y, mesh.getVertexAt(
                                    mesh.getTriangleAt(i).getPoint0())
                                    .getNormal().z);
                } else
                {
                    gl.glNormal3d(-mesh.getVertexAt(
                ...
                gl.glVertex3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint0()).getPosition().x,
                        mesh.getVertexAt(mesh.getTriangleAt(i).getPoint0())
                                .getPosition().y, mesh.getVertexAt(
                                mesh.getTriangleAt(i).getPoint0())
                                .getPosition().z);
                ...
                {
                    gl.glNormal3d(mesh.getVertexAt(
                            mesh.getTriangleAt(i).getPoint1()).getNormal().x,
                            mesh.getVertexAt(mesh.getTriangleAt(i).getPoint1())
                                    .getNormal().y, mesh.getVertexAt(
                                    mesh.getTriangleAt(i).getPoint1())
                                    .getNormal().z);
                } else
                {
                    gl.glNormal3d(-mesh.getVertexAt(
                ...
                gl.glVertex3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint1()).getPosition().x,
                        mesh.getVertexAt(mesh.getTriangleAt(i).getPoint1())
                                .getPosition().y, mesh.getVertexAt(
                                mesh.getTriangleAt(i).getPoint1())
                                .getPosition().z);
                ...
                {
                    gl.glNormal3d(mesh.getVertexAt(
                            mesh.getTriangleAt(i).getPoint2()).getNormal().x,
                            mesh.getVertexAt(mesh.getTriangleAt(i).getPoint2())
                                    .getNormal().y, mesh.getVertexAt(
                                    mesh.getTriangleAt(i).getPoint2())
                                    .getNormal().z);
                } else
                {
                    gl.glNormal3d(-mesh.getVertexAt(
                ...
                gl.glVertex3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint2()).getPosition().x,
                        mesh.getVertexAt(mesh.getTriangleAt(i).getPoint2())
                                .getPosition().y, mesh.getVertexAt(
                                mesh.getTriangleAt(i).getPoint2())
                                .getPosition().z);
            ...
            int texObj)
    {
        ...
        for (int i = ini; i < fin; i++)
        {
            ...
            {
                gl.glNormal3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint0()).getNormal().x, mesh
                        .getVertexAt(mesh.getTriangleAt(i).getPoint0())
                        .getNormal().y, mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint0()).getNormal().z);

                gl.glTexCoord2d(mesh.getVerTextureAt(mesh.getTriangleAt(i)
                        .getVt0()).x, mesh.getVerTextureAt(mesh
                        .getTriangleAt(i).getVt0()).y);
                ...
                gl.glNormal3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint1()).getNormal().x, mesh
                        .getVertexAt(mesh.getTriangleAt(i).getPoint1())
                        .getNormal().y, mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint1()).getNormal().z);

                gl.glTexCoord2d(mesh.getVerTextureAt(mesh.getTriangleAt(i)
                        .getVt1()).x, mesh.getVerTextureAt(mesh
                        .getTriangleAt(i).getVt1()).y);
                ...
                gl.glNormal3d(mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint2()).getNormal().x, mesh
                        .getVertexAt(mesh.getTriangleAt(i).getPoint2())
                        .getNormal().y, mesh.getVertexAt(
                        mesh.getTriangleAt(i).getPoint2()).getNormal().z);

                gl.glTexCoord2d(mesh.getVerTextureAt(mesh.getTriangleAt(i)
                        .getVt2()).x, mesh.getVerTextureAt(mesh
                        .getTriangleAt(i).getVt2()).y);
    ...
    public static void drawPoints(GL gl, Mesh mesh)
    {
        ...
        for (int i = 0; i < mesh.getVertexes().length; i++)
        {
            ...
            {
                gl.glVertex3d(mesh.getVertexAt(i).getPosition().x, mesh
                        .getVertexAt(i).getPosition().y, mesh.getVertexAt(i)
                        .getPosition().z);
            }
            gl.glEnd();
        }
    ...
    public static void drawNormalsTriangles(GL gl, Mesh m)
    {
        for (int i = 0; i < m.getTriangles().length; i++)
        {
            ...
            gl.glBegin(gl.GL_LINES);
            {
                ...
                gl.glVertex3d(cx + m.getTriangleAt(i).normal.x * 0.1, cy
                        + m.getTriangleAt(i).normal.y * 0.1, cz
                        + m.getTriangleAt(i).normal.z * 0.1);
            }
            gl.glEnd();
        }
    }
