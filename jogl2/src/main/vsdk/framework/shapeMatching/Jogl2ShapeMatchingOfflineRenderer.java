...
public class Jogl2ShapeMatchingOfflineRenderer extends Component implements GLEventListener {
    ...
    public Jogl2ShapeMatchingOfflineRenderer(int imageWidth, int imageHeight, JoglShapeMatchingOfflineRenderable target) {
